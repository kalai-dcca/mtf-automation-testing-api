...
public class DBUtilities {
    ...
    public static void createConnection(String url, String username, String password) {
        try {
            ...
            MyLogger.info("CONNECTION SUCCESSFUL");
        } catch (Exception e) {
            MyLogger.error("CONNECTION HAS FAILED " + e.getMessage(), e);
    ...
    public static ResultSet runQuery(String query) {
        try {
            ...
            MyLogger.error("ERROR OCCURRED WHILE RUNNING QUERY  " + e.getMessage(), e);
            throw new RuntimeException(e);
        }
        return resultSet;
    }
    ...
    public static void destroy() {
        try {
            ...
            MyLogger.error("ERROR OCCURRED WHILE CLOSING RESOURCES  " + e.getMessage(), e);
            throw new RuntimeException(e);
        }
    }
    ...
    public static int getRowCount() {
        ...
        try {
            ...
            MyLogger.error("ERROR OCCURRED WHILE GETTING ROW COUNT  " + e.getMessage(), e);
            throw new RuntimeException(e);
        } finally {
            resetCursor();
        }
    ...
    public static int getColumnCount() {
        ...
        try {
            ...
            MyLogger.error("ERROR OCCURRED WHILE GETTING COLUMN COUNT  " + e.getMessage(), e);
            throw new RuntimeException(e);
        }
        return columnCount;
    }
    ...
    public static List<String> getAllColumnNamesAsList() {
        ...
        try {
            ...
            MyLogger.error("ERROR OCCURRED WHILE getAllColumnNameAsList()  " + e.getMessage(), e);
            throw new RuntimeException(e);
        }
    ...
    public static List<String> getRowDataAsList(int rowNum) {
        ...
        try {
            ...
            MyLogger.error("ERROR OCCURRED WHILE RUNNING getRowDataAsList()  " + e.getMessage(), e);
            throw new RuntimeException(e);
        } finally {
            resetCursor();
        }
    ...
    public static String getCellValue(int rowNum, int columnIndex) {
        ...
        try {
            ...
            MyLogger.error("ERROR OCCURRED WHILE RUNNING getCellValue()  " + e.getMessage(), e);
            throw new RuntimeException(e);
        } finally {
            resetCursor();
        }
    ...
    public static List<String> getColumnDataAsList(int columnNum) {
        ...
        try {
            ...
            MyLogger.error("ERROR OCCURRED WHILE RUNNING getColumnDataAsList()  " + e.getMessage(), e);
            throw new RuntimeException(e);
        } finally {
            resetCursor();
        }
        ...
        try {
            while (resultSet.next()) {
                for (int i = 1; i <= columnCount; i++) {
                    MyLogger.info(String.format("%-25s", resultSet.getString(i)));
                }
            }
        } catch (SQLException e) {
            MyLogger.error("ERROR OCCURRED WHILE RUNNING displayAllData()  " + e.getMessage(), e);
            throw new RuntimeException(e);
        }
    }
    ...
    public static Map<String, String> getRowMap(int rowNum) {
        ...
        try {
            ...
            MyLogger.error("ERROR OCCURRED WHILE RUNNING getRowMap()  " + e.getMessage(), e);
            throw new RuntimeException(e);
        } finally {
            resetCursor();
        }
